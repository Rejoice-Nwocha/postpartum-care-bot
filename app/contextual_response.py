...
from app.conversation_context import extract_days, normalise
    ...
    if topic == "lochia":
        ...
        if days is not None:
            return BrainResponse(
                f"Thank you for telling me, Mama. I've noted that you're about day {days} postpartum. Lochia can change as recovery progresses, so the next thing I want to understand is how the bleeding is changing and whether you have any other symptoms.",
